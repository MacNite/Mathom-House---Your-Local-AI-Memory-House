...
const translations: Record<Lang, Record<string, string>> = {
  en: {
    ...
    'upload.source.text': 'Paste text',
    'upload.source.document': 'Document',
    'upload.text': 'Text (up to 500,000 characters)',
    ...
    'upload.speakerLabel': 'Speaker',
    'upload.speakerPlaceholder': 'e.g. Max, or Mum and me',
    'upload.sourceApp': 'Source',
    'upload.summaryStyle': 'Summary style',
    'upload.templatesFailed': 'Summary styles could not be loaded. Please try again.',
  ...
  de: {
    ...
    'upload.source.text': 'Text einfügen',
    'upload.source.document': 'Dokument',
    'upload.text': 'Text (bis zu 500.000 Zeichen)',
    ...
    'upload.speakerLabel': 'Sprecher:in',
    'upload.speakerPlaceholder': 'z. B. Max, oder Mama und ich',
    'upload.sourceApp': 'Quelle',
    'upload.summaryStyle': 'Zusammenfassungsstil',
    'upload.templatesFailed': 'Zusammenfassungsstile konnten nicht geladen werden. Bitte erneut versuchen.',
    ...
    'detail.speakerPrefix': 'Sprecher:in',
  ...
  es: {
    ...
    'upload.source.text': 'Pegar texto',
    'upload.source.document': 'Documento',
    'upload.text': 'Texto (hasta 500.000 caracteres)',
    ...
    'upload.speakerLabel': 'Voz',
    'upload.speakerPlaceholder': 'p. ej. Max, o mamá y yo',
    'upload.sourceApp': 'Fuente',
    'upload.summaryStyle': 'Estilo de resumen',
    'upload.templatesFailed': 'No se pudieron cargar los estilos de resumen. Inténtalo de nuevo.',
